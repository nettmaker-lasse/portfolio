					...
					<div className="flex flex-row items-center justify-center w-full space-x-4 lg:w-4/12 lg:justify-end">
						...
						>
							<svg
								...
								height="16"
								fill="currentColor"
								className="w-5 h-5 bi bi-instagram text-red"
								viewBox="0 0 16 16"
							>
						...
						>
							<svg
								...
								height="16"
								fill="currentColor"
								className="w-5 h-5 text-black dark:text-white bi bi-twitter"
								viewBox="0 0 16 16"
							>
						...
						>
							<svg
								...
								height="16"
								fill="currentColor"
								className="w-5 h-5 text-black dark:text-white bi bi-linkedin"
								viewBox="0 0 16 16"
							>
