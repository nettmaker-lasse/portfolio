...
export default function Contact() {
	...
	return (
		<section>
			...
			<div className="relative z-10 max-w-6xl mx-auto mb-20 -mt-4 dark:shadow-3xl">
				<div className="grid grid-cols-1 gap-20 md:grid-cols-2">
					<div className="">
						...
						<div className="inline-flex flex-col w-full mt-4 mb-10 icons-container md:full">
							<div className="flex flex-row items-center p-4 mb-4 space-x-6 border border-black hover:border hover:border-synthPink dark:border-synthPink">
								<svg
						...
						<div className="flex flex-row space-x-8 social-icons">
							...
							>
								<svg
									...
									height="16"
									fill="currentColor"
									className="w-5 h-5 bi bi-instagram text-synthPink"
									viewBox="0 0 16 16"
								>
							...
							>
								<svg
									...
									height="16"
									fill="currentColor"
									className="w-5 h-5 text-blue-500 bi bi-twitter"
									viewBox="0 0 16 16"
								>
							...
							>
								<svg
									...
									height="16"
									fill="currentColor"
									className="w-5 h-5 text-blue-700 bi bi-linkedin"
									viewBox="0 0 16 16"
								>
					...
					<div className="mt-10 contactform md:mt-0">
						...
						>
							...
							<input
								className="px-3 py-2 mt-2 mb-6 text-sm font-light text-black bg-white border focus:outline-none focus:ring-2 focus:border-none ring-synthPink dark:border-black"
								type="text"
								name="user_name"
							/>
							<label className="text-sm text-black dark:text-white">
