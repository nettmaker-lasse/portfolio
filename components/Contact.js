				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-20">
					<div className="">
						<header className="">
							...
							<p className="font-light text-base text-black mt-2 dark:text-white">
								Fill in the details and I'll get back to you as
								soon as I can.
							</p>
						</header>
						<div className="icons-container w-full inline-flex flex-col my-10 md:full md:my-20">
							<div className="flex flex-row items-center space-x-6 rounded-md mb-4 border border-black hover:border hover:border-synthPink p-4 dark:border-synthPink">
								...
								<p className="text-black font-light text-sm dark:text-white">
									{userData.phone}
								</p>
							</div>
							<div className="flex flex-row items-center space-x-6 rounded-md mb-4 border border-black hover:border hover:border-synthPink p-4 dark:border-synthPink">
