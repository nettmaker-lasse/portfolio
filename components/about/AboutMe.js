				...
				<div className="pt-20 grid grid-cols-1 md:grid-cols-3 max-w-6xl mx-auto gap-y-20 gap-x-20">
					...
					<div className="inline-flex flex-col">
						...
						<div className="mt-8">
							...
							<p className="text-lg text-gray-500 mt-4 dark:text-gray-300 dark:text-white">
								I'm currently not looking for a job, If you see me as a good fit
					...
					<div className="col-span-1 md:col-span-2 ">
						...
						<h3 className="text-2xl md:text-3xl font-semibold text-black dark:text-white mt-8 mb-2">
							{userData.about.descriptionSeparator}
						</h3>
						<p className="text-black mb-4 dark:text-white leading-8">
