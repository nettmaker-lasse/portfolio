    ...
    <div>
      <div className="">
        ...
        <div className="max-w-6xl mx-auto">
			...
			<h1 className=" text-5xl md:text-9xl mb-8 font-bold text-center md:text-left dark:text-white">
			{title}
			</h1>
		</div>
        <div className="container grid grid-cols-2 gap-8 max-w-6xl mx-auto">
		{Object
		  .keys(images)
		  .filter((e, i) => i!=0)
		  .map((item, i)  => (
			<div className="w-full rounded rounded-md relative overflow-hidden shadow-2xl" key={images[item]._key}>
			<img
